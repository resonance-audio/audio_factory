  ...
  public void OnUpdate() {
    ...
    if (IsPointerIntersecting) {
      ...
      lineEndPoint = base.PointerTransform.position + (base.PointerTransform.forward * MaxLaserDistance);
        ...
        //*********************Hack for Audio factory***********************//
        //**this moved the laser in, in the case that the laser intersects**//
        //******************************************************************//
        Ray laserRay = new Ray(base.PointerTransform.position, lineEndPoint - base.PointerTransform.position);
        RaycastHit laserHit;
        if (Physics.Raycast(laserRay, out laserHit, Vector3.Distance(lineEndPoint, base.PointerTransform.position))) {
            lineEndPoint = laserHit.point;
        }
        //*******************Hack for Audio factory**********************//
