...
public interface IGameManagerMessageHandler {
    void StartedLoadingRoom(RoomDefinition room);
    void DoneLoadingRoom(RoomDefinition room);
}

public class GameManagerMessageHandler : MonoBehaviour, IGameManagerMessageHandler {

    [SerializeField] UnityEvent onStartedLoadingRoom = null;
    [SerializeField] UnityEvent onDoneLoadingRoom = null;
